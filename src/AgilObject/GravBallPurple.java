...
public class GravBallPurple {
    ...
    public GravBallPurple(String id, int x, int y, int width, int height, int speedX, int speedY, GravBallPhysics phy, boolean needRemoval){
        this._id = id;
        this._x = x;
        this._y = y;
        this._width = width;
